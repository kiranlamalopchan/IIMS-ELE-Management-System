...
Public Class FourtthSemELEData
    ...
    Private Sub FourtthSemELEData_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call loaddata()
    End Sub
    ...
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        If e.RowIndex >= 0 Then
            ...
            sender.Text = row.Cells("Student_Name").Value.ToString
