...
Public Class FifthSemELEAdmin
    ...
    Sub ShowGrid()
        Call Connection()
        da = New SqlDataAdapter("select * from FifthSem", conn)
        ds = New DataSet
        da.Fill(ds)
    ...
    Private Sub FifthSemELEAdmin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call loaddata()
    End Sub
