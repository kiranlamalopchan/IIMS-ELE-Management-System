...
Public Class ELEPointStudentView
    ...
    Private Sub BunifuThinButton23_Click(sender As Object, e As EventArgs) Handles BunifuThinButton23.Click
        ...
        Try
            conn.Open()
            Dim query As String
            query = "Select Event_Name,Point From FourthSem where Student_ID ='" & ELE_Search_Spec.Text & "'"
            Command = New SqlCommand(query, conn)
            sda.SelectCommand = Command
            sda.Fill(dbdataset)
            bsource.DataSource = dbdataset
    ...
    Private Sub BunifuThinButton24_Click(sender As Object, e As EventArgs) Handles BunifuThinButton24.Click
        ...
        Try
            conn.Open()
            Dim query As String
            query = "Select Event_Name,Point From FifthSem where Student_ID ='" & ELE_Search_Spec.Text & "'"
            Command = New SqlCommand(query, conn)
            sda.SelectCommand = Command
            sda.Fill(dbdataset)
            bsource.DataSource = dbdataset
    ...
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        If e.RowIndex >= 0 Then
            ...
            ELE_Search_Spec.Text = row.Cells("Student_ID").Value.ToString
            BunifuMaterialTextbox1.Text = row.Cells("Student_Name").Value.ToString
