...
Public Class RegisteredStudents
    ...
    Sub ShowGrid()
        Call Connection()
        sda = New SqlDataAdapter("select * from Lg_Students", conn)
        ds = New DataSet
        sda.Fill(ds)
    ...
    Private Sub BunifuThinButton21_Click(sender As Object, e As EventArgs) Handles BunifuThinButton21.Click
        ...
        ElseIf MessageBox.Show("Are you sure to Delete...?", "Be carefull", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
            Call Connection()
            conn.Open()
            Dim delete As String = "delete from [Lg_Students]  where firstname ='" & Search_textbox.Text & "'"
    ...
    Private Sub RegisteredStudents_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call loaddata()
    End Sub
End Class